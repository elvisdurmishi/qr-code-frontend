...
const SettingsCard = () => {
    return (
        <div className={"bg-secondary h-[90%] w-3/12 rounded-3xl grid grid-rows-4 gap-4 place-items-center p-8"}>
            ...
            <div className={"flex gap-4"}>
                <Button icon={<CgSoftwareDownload size={28} />} text={"JPG"} color={"lightblue"}/>
            </div>
        </div>
    )
}
    ...
    return (
        <div className={"flex flex-col gap-3"}>
            <div className={"flex flex-col items-center accordion-content-item"}>
                <input type="color" id="background" name="head" value="#e66465" />
                <label htmlFor="background">Background</label>
            </div>
            <div className={"flex flex-col items-center accordion-content-item"}>
                <input type="color" id="foreground" name="head" value="#fff" />
